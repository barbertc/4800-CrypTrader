...
fn account_balance(creds: String, user: String) {
...
fn get_orders(creds: String, user: String) {
...
fn mk_buy(creds: String, vol: String, par: String) {
...
fn mk_sell(creds: String, vol: String, par: String) {
